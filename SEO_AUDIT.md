...
- **Fases 3, 11:** no implementadas todavía. Requieren decisión explícita antes de continuar:
  ...
  - **Fase 11** (Analytics/GA4/GTM/Search Console) requiere que el propietario provea IDs reales — no se puede inventar ninguno.
